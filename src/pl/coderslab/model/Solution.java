...
public class Solution {
	...
	//DO DUPY działa do 3 elementów w tabeli :<
	public User getUser(){
		User user = null;
		try{
			Connection con = DbUtil.getConnection();
			user = User.loadUserById(con, this.user_id);
	...
	public Excercise getExcercise(){
		...
		try{
			Connection con = DbUtil.getConnection();
			exe = Excercise.loadExcerciseById(con, this.excercise_id);
		}catch(SQLException e){
		}
		return exe;
	}
	...
	public static Solution[] loadAllSolutions(Connection con, int limit) throws SQLException{
		ArrayList<Solution> solutions = new ArrayList<Solution>();
